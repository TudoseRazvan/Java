...
public class Element implements Comparable<Element>, Serializable {
    ...
    //Testare egalitate dupa index linie, index coloana si valoare
    //Doua elemente sunt egale daca au aceeasi pozitie si valori egale
    @Override
    public boolean equals(Object o) {
       ...
       return indexLinie == element.indexLinie && indexColoana == element.indexColoana
               && Double.compare(valoareElement, element.valoareElement)==0;
    }
    ...
    //Comparabiltiate -> !!! pune implements Comparable<Element> sus
    @Override
